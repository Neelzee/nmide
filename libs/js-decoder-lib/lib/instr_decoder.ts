...
import type { Html, Instruction, Attr, Value, Event } from "@nmide/js-utils";
import { DDialogFileKind, DDialogEvtKind, DDialogBtn } from "./event_decoder";
import { OptionalString } from "./html_decoder";
import { DValueNull, DValueInt, DValueFloat, DValueBool, DValueStr } from "./value_decoder";
...
export const DInstrHtml: t.Type<Instruction<Html>> = t.recursion("DInstrHtml", () => {
  ...
  return DInstr("DInstrHtml", DHtml);
});

export const DInstrString: t.Type<Instruction<string>> = DInstr("DInstrHtml", t.string);
export const DInstrAttr: t.Type<Instruction<Attr>> = t.recursion("DInstrAttr", () => {
  const DValue: t.Type<Value> = t.recursion("DValue", () => {
  ...
  return DInstr("DInstrAttr", DAttr);
});

export const DInstrValue: t.Type<Instruction<Value>> = t.recursion("DInstrValue", () => {
  const DValue: t.Type<Value> = t.recursion("DValue", () => {
  ...
  return DInstr("DInstrValue", DValue);
});
