...
\begin{abstract}
  ...
  often inadequate. This can be solved by extensively using the module
  architecture of existing \gls{ide}s. Relying on \textit{niche} modules or
  functionality is not beneficial for the longevity of the software. By
  analyzing the essential features of traditional \gls{ide}s a need for
