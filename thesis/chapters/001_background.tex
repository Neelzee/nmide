...
practially. Note the empty interfaces; there is nothing that enforces the
...
targeting specific langauge, like \gls{eclipse} and \gls{intellij}. Others are
...
features. So a specialized \gls{ide} should contian the following features:
