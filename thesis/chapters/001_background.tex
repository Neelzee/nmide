...
% TODO: Should rewrite this to sound less like "I mean/feel this", to
% "I've observed this"
...
% TODO: Find an example of software that sucks, but is still use, that is *not*
% the current Magnolia IDE. Maybe mention COBOL? It is by todays standards
% outdated, and only in use to existing projects. I don't think many new
% projects are started in COBOL, but this is not software.

% TODO: Explain what is meant by popular, maybe a chance to add graphs? O.o
% TODO: Find a source for this claim.
