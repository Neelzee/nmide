...
\begin{table}[]
  ...
  \begin{tabular}{|l|l|}
    ...
    Eclipse & $1200~$ \\ \hline %\footnote{Found at \href{https://marketplace.eclipse.org/content/welcome-eclipse-marketplace}{Eclipse Marketplace}}
    Nvim & $4600~$ \\ \hline %\footnote{Found by looking at search results on \href{https://github.com/search?q=nvim+plugin&type=repositories}{GitHub}}
    Intellij & $9500~$ \\ \hline %\footnote{Found at \href{https://plugins.jetbrains.com/}{Intellij Marketplace}}
    \gls{vim} & $11500~$ \\ \hline %\footnote{Found by looking at search results on \href{https://github.com/search?q=nvim+plugin&type=repositories}{GitHub}}
    VS Code & $71700~$ \\ \hline %\footnote{Found by doing an empty search at \href{https://marketplace.visualstudio.com/search?target=VSCode&category=All%20categories&sortBy=Installs}{VS Code Marketplace}}
  \end{tabular}
\end{table}
