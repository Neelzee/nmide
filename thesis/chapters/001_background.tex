...
\textbf{List} interface in Java, which informs consumers of that interface,
...
uphold. A simple example of this would be a concept for addition with natural
numbers.
...
Gradle\footnote{\url{https://gradle.org/}} for Java/Kotlin, where needed to
...
files, another program was used. But for C/C++ or Java/Kotlin, external
...
When developing, an important part is code review, another developer ensuring
...
In the picture
\ref{pic:vcsViz}, we can see an example of this.
...
\todo{Add proof? Can I get some category theory stuff?}
