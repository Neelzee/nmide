...
section \ref{sec:stack}, we will mention technologies used, and the reasoning
behind them. In section \ref{sec:mod1} and \ref{sec:mod2}, we will discuss the
...
therefore, modules can be tested alone

\subsection{Unit Testing}

A module developer should create unit tests for their module.

\subsection{Automated UI Testing}

\todo{Mention the automated script generation, or playwright?}
